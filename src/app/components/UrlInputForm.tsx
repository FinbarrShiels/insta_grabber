    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="relative flex flex-col md:block">
        <input
          ...
          className="w-full px-5 py-4 bg-white/25 backdrop-blur-sm border border-white/40 rounded-xl focus:outline-none focus:ring-2 focus:ring-white text-white placeholder:text-white md:pr-56 pr-36 shadow-lg"
        />
        ...
        {/* Mobile version: Clear/Paste button inside input */}
