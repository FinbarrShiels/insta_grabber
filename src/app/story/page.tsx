    ...
    <main className="min-h-screen bg-gradient-to-br from-purple-600 to-pink-500 flex flex-col">
      ...
      <div className="container mx-auto px-4 pb-20 max-w-[984px]">
        ...
        <DemoSection 
          ...
          content="Instagram Stories disappear after 24 hours, but with our Story Downloader, you can save them forever. Download any public Instagram Story in high quality without login. Perfect for preserving memories, inspirational content, or important announcements before they expire."
          imageSrc="/images/story.png"
          imageAlt="Instagram Story Downloader Demo"
        />
